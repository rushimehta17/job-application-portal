<?php
	...
	if(isset($_POST['login'])){
    	...
    	$query=mysqli_query($con,"select * from jobavailable where Email='$loginuser' && SPassword='$password'"); 
...
<br>
		<a href="login.php">Login as Employee </a> <br><a href="adminlogin.php">Login as Admin </a>
	</div>
</body>
</html>